package com.yy.cloud.core.adminmgmt;
...
import com.yy.cloud.core.adminmgmt.data.domain.Member;

@SpringBootApplication
@ComponentScan(basePackages = { "com.yy.adminmgmt.config", "com.yy.adminmgmt.data" })
