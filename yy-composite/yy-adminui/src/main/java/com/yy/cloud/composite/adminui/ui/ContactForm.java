...
public class ContactForm extends FormLayout {
	private static final long serialVersionUID = -6674998779624021363L;
    ...
    DateField createTime = new DateField("Create date");

    Member contact;

    // Easily bind forms to beans and manage validation and buffering
    BeanFieldGroup<Member> formFieldBindings;
    ...
    private void buildLayout() {
        ...
        addComponents(actions, name, nickName, phone, email, createTime);
    }
