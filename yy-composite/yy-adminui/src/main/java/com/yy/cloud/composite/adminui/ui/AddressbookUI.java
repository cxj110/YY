package com.yy.cloud.composite.adminui.ui;


import com.yy.cloud.composite.adminui.clients.MemberClient;
import com.yy.cloud.composite.adminui.models.Member;
...
public class AddressbookUI extends UI {
    ...
    private void configureComponents() {
         ...
         */
        newContact.addClickListener(e -> contactForm.edit(new Member()));

        filter.setInputPrompt("Filter contacts...");
        filter.addTextChangeListener(e -> refreshContacts(e.getText()));

        contactList.setContainerDataSource(new BeanItemContainer<>(Member.class));
        contactList.setColumnOrder("id", "name", "nickName", "email");
        contactList.removeColumn("birthDate");
        contactList.setSelectionMode(Grid.SelectionMode.SINGLE);
        contactList.addSelectionListener(e
                -> contactForm.edit((Member) contactList.getSelectedRow()));
        refreshContacts();
    }
    ...
    private void refreshContacts(String stringFilter) {
        contactList.setContainerDataSource(new BeanItemContainer<>(
        		Member.class, userClient.findAll().getContent()));
